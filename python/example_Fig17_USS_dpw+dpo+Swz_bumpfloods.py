...
# Fig. 17 from Berg et al. Simultaneous Determination of Relative Permeability and Capillary Pressure ... paper
...
* match production curve, pressure drop vs. time, and saturation profiles
* include 3 "bump floods" at successively increased flow rate for better constraining solution
...
Schedule = pd.DataFrame( 
     [[0.0,    0.1, 1.0],
      [1.4,  2*0.1, 1.0],     # bump floods
      [1.6,  5*0.1, 1.0],
      [1.8,  10*0.1, 1.0]],    # bump floods
    columns=['StartTime','InjRate','FracFlow'] )
...
#sattimelistn = [0,1,4,8,12,16,20,24,28,32,36]
#sattimelistn = [0,4,8,12,16,20,72,82,86,92,98]
sattimelistn = [0,1,4,8,12,16,20,24,28,36,50,60,72,80,82,86,90,92,98]
